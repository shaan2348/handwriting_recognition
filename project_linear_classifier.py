...
# declaring the model type to fit the data in
classifier = learn.LinearClassifier(feature_columns = feature_columns, n_classes=10)
# fitting the data into declared model
# it takes input of data, labels, batch size and number of steps to perform
